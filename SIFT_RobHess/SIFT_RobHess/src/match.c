...
int main(int argc, char** argv)
{
	...
	// //cvWaitKey(0);
	//}
	char path1[80] = "E:\\Local Repositories\\SIFT_Snow\\SIFT_RobHess\\SIFT_RobHess\\feat1pca16.txt";
	char path2[80] = "E:\\Local Repositories\\SIFT_Snow\\SIFT_RobHess\\SIFT_RobHess\\feat2pca16.txt";
